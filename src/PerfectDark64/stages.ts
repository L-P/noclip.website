...
export const stages: Array<Stage> = [
    ...
    {id: StageID.MPArea52,     setupPath: "Usetupmp3Z",  padsPath: "bgdata/bg_mp3_padsZ",  bgPath: "bgdata/bg_mp3.seg",  skyRoom: 0x00, skyColor: colorNewFromRGBA8(0x000008ff)},
    {id: StageID.MPBase,       setupPath: "Usetupmp1Z",  padsPath: "bgdata/bg_mp1_padsZ",  bgPath: "bgdata/bg_mp1.seg",  skyRoom: 0x00, skyColor: colorNewFromRGBA8(0x040000ff)},
    {id: StageID.MPCarPark,    setupPath: "Usetupmp5Z",  padsPath: "bgdata/bg_mp5_padsZ",  bgPath: "bgdata/bg_mp5.seg",  skyRoom: 0x00, skyColor: OpaqueBlack},
    {id: StageID.MPFortress,   setupPath: "Usetupmp12Z", padsPath: "bgdata/bg_mp12_padsZ", bgPath: "bgdata/bg_mp12.seg", skyRoom: 0x00, skyColor: colorNewFromRGBA8(0x000008ff)},
    {id: StageID.MPG5Building, setupPath: "UsetupcrypZ", padsPath: "bgdata/bg_cryp_padsZ", bgPath: "bgdata/bg_cryp.seg", skyRoom: 0x00, skyColor: colorNewFromRGBA8(0x000008ff)},
    {id: StageID.MPGrid,       setupPath: "Usetupmp15Z", padsPath: "bgdata/bg_mp15_padsZ", bgPath: "bgdata/bg_mp15.seg", skyRoom: 0x00, skyColor: colorNewFromRGBA8(0x000008ff)},
    {id: StageID.MPPipes,      setupPath: "UsetupcradZ", padsPath: "bgdata/bg_crad_padsZ", bgPath: "bgdata/bg_crad.seg", skyRoom: 0x00, skyColor: OpaqueBlack},
    {id: StageID.MPRavine,     setupPath: "UsetuparecZ", padsPath: "bgdata/bg_arec_padsZ", bgPath: "bgdata/bg_arec.seg", skyRoom: 0x00, skyColor: OpaqueBlack},
    {id: StageID.MPRuins,      setupPath: "Usetupmp9Z",  padsPath: "bgdata/bg_mp9_padsZ",  bgPath: "bgdata/bg_mp9.seg",  skyRoom: 0x00, skyColor: OpaqueBlack},
    {id: StageID.MPSewers,     setupPath: "Usetupmp10Z", padsPath: "bgdata/bg_mp10_padsZ", bgPath: "bgdata/bg_mp10.seg", skyRoom: 0x00, skyColor: OpaqueBlack},
    {id: StageID.MPSkedar,     setupPath: "UsetupoatZ",  padsPath: "bgdata/bg_oat_padsZ",  bgPath: "bgdata/bg_oat.seg",  skyRoom: 0x00, skyColor: OpaqueBlack},
    {id: StageID.MPVilla,      setupPath: "Usetupmp13Z", padsPath: "bgdata/bg_mp13_padsZ", bgPath: "bgdata/bg_mp13.seg", skyRoom: 0x00, skyColor: colorNewFromRGBA8(0x8888dcff)},
    {id: StageID.MPWarehouse,  setupPath: "Usetupmp4Z",  padsPath: "bgdata/bg_mp4_padsZ",  bgPath: "bgdata/bg_mp4.seg",  skyRoom: 0x00, skyColor: colorNewFromRGBA8(0x020000ff)},

    {id: StageID.MPComplex,  setupPath: "UsetuprefZ",  padsPath: "bgdata/bg_ref_padsZ",  bgPath: "bgdata/bg_ref.seg",  skyRoom: 0x00, skyColor: colorNewFromRGBA8(0x020000ff)},
    {id: StageID.MPFelicity, setupPath: "Usetupmp11Z", padsPath: "bgdata/bg_mp11_padsZ", bgPath: "bgdata/bg_mp11.seg", skyRoom: 0x00, skyColor: colorNewFromRGBA8(0x040500ff)},
    {id: StageID.MPTemple,   setupPath: "UsetupjunZ",  padsPath: "bgdata/bg_jun_padsZ",  bgPath: "bgdata/bg_jun.seg",  skyRoom: 0x00, skyColor: colorNewFromRGBA8(0x001080ff)},
];
